...
class Raindrop(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        ...
        # Load the raindrop image and set its rect. If the image is missing,
        # create a simple fallback surface so the program still runs.
        try:
    ...
    def update(self):
        ...
        # Ensure rect uses integer coordinates
